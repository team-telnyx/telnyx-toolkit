...
Retry the original blocked operation. If it still fails, refresh the API key via `telnyx-bot-signup` (same email, sign-in flow).
...
| API key invalid (401) | Check `TELNYX_API_KEY` or re-run telnyx-bot-signup |
